    ...
    handler: async (request, reply) => {
      ...
      try {
        ...
        const prompt = `
          ...
          99A descrição da vaga é: "${jobDetails.description}".
    ...
    handler: async (request, reply) => {
      ...
      try {
        ...
        const prompt = `
            ...
            Transcrição:\n${conversationText}\n
            Com base na conversa, forneça uma avaliação do candidato em formato JSON com as chaves: "summary", "strengths", "weaknesses", "score".
            `;
